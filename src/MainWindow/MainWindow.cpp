...
MainWindow::MainWindow() {
    ...
    connect(&commandConsole, &CommandConsole::unknownCommand, &logWindow, &LogWindow::handleUnknownCommand);
    ...
    connect(toolbar, &ToolBar::unknownCommand, &logWindow, &LogWindow::handleUnknownCommand);
